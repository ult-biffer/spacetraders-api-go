...
type ContractsApi interface {
	...
	*/
	AcceptContract(ctx context.Context, contractId string) ApiAcceptContractRequest

	// AcceptContractExecute executes the request
	//  @return AcceptContract200Response
	AcceptContractExecute(r ApiAcceptContractRequest) (*AcceptContract200Response, *http.Response, error)
	...
	*/
	DeliverContract(ctx context.Context, contractId string) ApiDeliverContractRequest

	// DeliverContractExecute executes the request
	//  @return DeliverContract200Response
	DeliverContractExecute(r ApiDeliverContractRequest) (*DeliverContract200Response, *http.Response, error)
	...
	*/
	FulfillContract(ctx context.Context, contractId string) ApiFulfillContractRequest

	// FulfillContractExecute executes the request
	//  @return FulfillContract200Response
	FulfillContractExecute(r ApiFulfillContractRequest) (*FulfillContract200Response, *http.Response, error)
	...
	*/
	GetContract(ctx context.Context, contractId string) ApiGetContractRequest
	...
	*/
	...
	GetContractsExecute(r ApiGetContractsRequest) (*GetContracts200Response, *http.Response, error)
}
