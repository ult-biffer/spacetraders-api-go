...
type FactionsApi interface {
	...
	*/
	GetFaction(ctx context.Context, factionSymbol string) ApiGetFactionRequest

	// GetFactionExecute executes the request
	//  @return GetFaction200Response
	GetFactionExecute(r ApiGetFactionRequest) (*GetFaction200Response, *http.Response, error)
	...
	*/
	GetFactions(ctx context.Context) ApiGetFactionsRequest

	// GetFactionsExecute executes the request
	//  @return GetFactions200Response
	GetFactionsExecute(r ApiGetFactionsRequest) (*GetFactions200Response, *http.Response, error)
}
